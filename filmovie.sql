...
INSERT INTO `tpost` (`id`, `threadId`, `authorId`, `creationTime`, `contents`) VALUES
...
INSERT INTO `tthread` (`id`, `authorId`, `topicId`, `subject`, `creationTime`) VALUES
...
INSERT INTO `tuser` (`id`, `login`, `password`, `email`, `birthday`, `gender`, `joinDate`, `place`, `function`) VALUES
